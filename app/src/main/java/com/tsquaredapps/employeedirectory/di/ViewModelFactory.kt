...
import com.tsquaredapps.employeedirectory.directory.DirectoryViewModel
import dagger.Binds
...
@Inject constructor(private val viewModels: MutableMap<Class<out ViewModel>, Provider<ViewModel>>) :
    ...
    abstract class ViewModelModule {
        ...
        internal abstract fun bindUserInformationViewModel(viewModel: DirectoryViewModel): ViewModel
    }
}